...
import { Checkbox, Col, Divider, Form, Grid, Row } from 'antd'
...
import { DEVICES_MODEL_SELECTS, ACCESS_TYPE_SELECTS, ALERT_SELECTS, GRANT_SELECTS } from 'constants/common'
import { IDeviceDTO, IGroupOptions, IWatchlistdevice } from 'types'
import { useGetRole } from 'hooks'
import classes from '../BarcodeScanner.module.scss'
import { AlertTypeEnum, DescriptorTypeEnum, DeviceModelEnum, DeviceTypeEnum } from 'constants/enums'
...
const useBarcodeScannerForm = ({ data, visible, setVisible }: Props = {}) => {
  ...
  const onFinish = (values: any) => {
    ...
    const formData = {
      id: data?.id,
      type: DeviceTypeEnum.BarcodeScanner,
      title: values.title,
      model: values.model,
...
export default useBarcodeScannerForm

...
import { CAMERA_MODEL_SELECTS, ACCESS_TYPE_SELECTS, PRINTER_MODEL_SELECTS } from 'constants/common'
import { IDeviceDTO, IGroupOptions } from 'types'
import { useGetRole } from 'hooks'
import classes from '../Printer.module.scss'
import { AccessTypeEnum, DeviceModelEnum, DeviceTypeEnum, PrinterTypeEnum } from 'constants/enums'
...
const usePrinterForm = ({ data, visible, setVisible }: Props = {}) => {
          ...
          <Row gutter={xs ? 8 : 12}>
            ...
            <Col span={12}>
              <Form.Item name="model" label="Model:">
                <FormElements.Select options={PRINTER_MODEL_SELECTS} />
              </Form.Item>
            </Col>
          </Row>
  ...
  return (
    <Form
      ...
      layout="vertical"
      initialValues={{
        model: PRINTER_MODEL_SELECTS[DeviceModelEnum.Gateway].value,
